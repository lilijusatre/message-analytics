...
/**
 * Componente que muestra gráficos comparativos de mensajes por usuario durante el último trimestre
 *
 * @component
 * @example
 * ```jsx
 ...
 * ```
 *
 * @returns {JSX.Element} Gráficos de barras comparativos del último trimestre
 */
const ComparativaUsuariosTrimestre = () => {
  /**
  ...
  /**
   * Efecto que carga y procesa los datos para los gráficos del último trimestre
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('/mensajesPorUsuarioTrimestre.json')
  ...
  const optionsHoras = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Comparativa de Mensajes por Hora (Último Trimestre)',
        font: { size: 16 },
      },
    },
    scales: {
  ...
  const optionsDias = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Comparativa de Mensajes por Día (Último Trimestre)',
        font: { size: 16 },
      },
    },
    scales: {
...
export default ComparativaUsuariosTrimestre
